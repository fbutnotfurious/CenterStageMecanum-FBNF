...
public class Red_BackStage_CenterPark extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        MecanumRobotUtilities.InitializeHardware(Red_BackStage_CenterPark.this);
        ArmRobotUtilities.InitializeArm(Red_BackStage_CenterPark.this);
        ...
        InitializeCamera(Red_BackStage_CenterPark.this);
        SetPipeline();
