...
@Autonomous(name="Red Frontstage Robot Auto", group="Robot")
//@Disabled
public class Red_FrontStage_CornerPark extends LinearOpMode
{
    // List of Variables:
    long sleeptime = 100;
    ...
    public void runOpMode()
    {
        ...
        MecanumRobotUtilities.InitializeHardware(Red_FrontStage_CornerPark.this);
        ArmRobotUtilities.InitializeArm(Red_FrontStage_CornerPark.this);
        ...
        InitializeCamera(Red_FrontStage_CornerPark.this);
        SetPipeline();

        waitForStart();
        startCamera(Red_FrontStage_CornerPark.this);
        ...
        while (opModeIsActive())
        {
            if (location==Prop.CENTER)
            {
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.FORWARD, 0.4,
                                Path_Constants.FSR_WP_Center[0], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Wrist Down:
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.FORWARD, 0.4,
                                Path_Constants.FSR_WP_Center[1], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Open Gripper:
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.BACKWARD, driveSpeed,
                                Path_Constants.FSR_WP_Center[2], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Close Gripper:
                ArmRobotUtilities.OperateGripper(ArmRobotUtilities.gripperClosedPosition);
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.LEFT, driveSpeed,
                                Path_Constants.FSR_WP_Center[3], 10.0,
                                Red_FrontStage_CornerPark.this);
                // Move forward by 18:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.FORWARD, driveSpeed,
                                Path_Constants.FSR_WP_Center[4], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // strafe right by 18:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.RIGHT, turnSpeed,
                                Path_Constants.FSR_WP_Center[5], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // turn left by 21.5:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.SPINANTICLOCKWISE, 0.6,
                                Path_Constants.FSR_WP_Center[6], 10.0,
                                Red_FrontStage_CornerPark.this);
                ArmRobotUtilities.OperateWrist(ArmRobotUtilities.wristDownPosition);
                // move backward by 25:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.BACKWARD, 0.6,
                                Path_Constants.FSR_WP_Center[7], 10.0,
                                Red_FrontStage_CornerPark.this);
                ArmRobotUtilities.OperateWrist(ArmRobotUtilities.wristUpPosition);
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.BACKWARD, 0.6,
                                Path_Constants.FSR_WP_Center[8], 10.0,
                                Red_FrontStage_CornerPark.this);
                // Strafe Left by 25 inches:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.LEFT, 0.6,
                                Path_Constants.FSR_WP_Center[9], 10.0,
                                Red_FrontStage_CornerPark.this);

                // Backward by 8 inches:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.BACKWARD, 0.6,
                                Path_Constants.FSR_WP_Center[10], 10.0,
                                Red_FrontStage_CornerPark.this);
            ...
            else if (location==Prop.LEFT)
            {
                // Strafe Left:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.LEFT, 0.4,
                                Path_Constants.FSR_WP_Left[0], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Move Forward:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.FORWARD, 0.4,
                                Path_Constants.FSR_WP_Left[1], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Spin Clockwise:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.SPINCLOCKWISE, 0.4,
                                Path_Constants.FSR_WP_Left[2], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Strafe Left:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.LEFT, 0.4,
                                Path_Constants.FSR_WP_Left[3], 10.0,
                                Red_FrontStage_CornerPark.this);
                // Wrist Down:
                ArmRobotUtilities.OperateWrist(ArmRobotUtilities.wristDownPosition);
                sleep(1000);
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.FORWARD, 0.4,
                                Path_Constants.FSR_WP_Left[4], 10.0,
                                Red_FrontStage_CornerPark.this);
                // Open Gripper:
                ArmRobotUtilities.OperateGripper(ArmRobotUtilities.gripperOpenPosition);
                sleep(sleeptime);
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.BACKWARD, driveSpeed,
                                Path_Constants.FSR_WP_Left[5], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Close Gripper:
                ArmRobotUtilities.OperateGripper(ArmRobotUtilities.gripperClosedPosition);
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.BACKWARD, 0.4,
                                Path_Constants.FSR_WP_Left[6], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Strafe Left:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.LEFT, 0.4,
                                Path_Constants.FSR_WP_Left[7], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Spin Anticlockwise:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.SPINANTICLOCKWISE, driveSpeed,
                                Path_Constants.FSR_WP_Left[8], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Wrist Down
                ArmRobotUtilities.OperateWrist(ArmRobotUtilities.wristDownPosition);
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.BACKWARD, driveSpeed,
                                Path_Constants.FSR_WP_Left[9], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Wrist up
                ArmRobotUtilities.OperateWrist(ArmRobotUtilities.wristUpPosition);
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.BACKWARD, driveSpeed,
                                Path_Constants.FSR_WP_Left[10], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Strafe Left:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.LEFT, driveSpeed,
                                Path_Constants.FSR_WP_Left[11], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Raise Arm:
                ArmRobotUtilities.encoderArm(ArmRobotUtilities.armSpeed * 2,
            ...
            else
            {
                // Strafe Right:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.RIGHT, 0.4,
                                Path_Constants.FSR_WP_Right[0], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Move Forward:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.FORWARD, 0.4,
                                Path_Constants.FSR_WP_Right[1], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Wrist Down:
                ArmRobotUtilities.OperateWrist(ArmRobotUtilities.wristDownPosition);
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.FORWARD, driveSpeed,
                                Path_Constants.FSR_WP_Right[2], 10.0,
                                Red_FrontStage_CornerPark.this);
                // Open Gripper:
                ArmRobotUtilities.OperateGripper(ArmRobotUtilities.gripperOpenPosition);
                sleep(sleeptime);
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.BACKWARD, driveSpeed,
                                Path_Constants.FSR_WP_Right[3], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Close Gripper:
                ArmRobotUtilities.OperateGripper(ArmRobotUtilities.gripperClosedPosition);
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.LEFT, driveSpeed,
                                Path_Constants.FSR_WP_Right[4], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Move Forward:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.FORWARD, driveSpeed,
                                Path_Constants.FSR_WP_Right[5], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Spin Anticlockwise:
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.SPINANTICLOCKWISE, turnSpeed,
                                Path_Constants.FSR_WP_Right[6], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Wrist Down
                ArmRobotUtilities.OperateWrist(ArmRobotUtilities.wristDownPosition);
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.BACKWARD, driveSpeed,
                                Path_Constants.FSR_WP_Right[7], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Wrist up
                ArmRobotUtilities.OperateWrist(ArmRobotUtilities.wristUpPosition);
                ...
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.BACKWARD, driveSpeed,
                                Path_Constants.FSR_WP_Right[8], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Strafe left
                MecanumRobotUtilities.encoderDrive
                        (Auto_Struct.RobotDirection.LEFT, driveSpeed,
                                Path_Constants.FSR_WP_Right[9], 10.0,
                                Red_FrontStage_CornerPark.this);
                sleep(sleeptime);
                // Raise Arm:
                ArmRobotUtilities.encoderArm(ArmRobotUtilities.armSpeed * 2,
    ...
    public  void InitializeCamera(LinearOpMode opMode )
    {
        ...
        if (detector==null)
        {detector = new WebcamPipeline(opMode.telemetry, StartPosition.RED_AUD);}
    }
