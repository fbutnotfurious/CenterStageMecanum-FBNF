...
public class TFOD_BlueFrontAprilTag extends LinearOpMode
{
   ...
   final String TFOD_MODEL_FILE = "CenterStage.tflite";
   // public static final String[] LABELS = {"blueDuplo", "redDuplo"};
    public static final String[] LABELS = {"whitePixel"};
    ...
    @Override public void runOpMode()
    {
     ...
     //PS   touchSensor = hardwareMap.get(TouchSensor.class, "sensor_touch");
        
        // Connect to servo "arm"
       //pS servo = hardwareMap.get(Servo.class, "arm");
      //pS  servo.setPosition(MAX_POS);
        ...
        while (opModeIsActive())
        {
           ...
           /*PSC if (currentStep==31) {
            ...
            if (currentStep==32) {
               ...
               //pSC servo.setPosition(position);
